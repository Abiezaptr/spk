...
class Admin extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $data['penilai'] = $this->admin_model->count_Penilai();
        $data['alternatif'] = $this->admin_model->get_Alternatif();
        $data['peringkat'] = $this->admin_model->getRankKaryawan($tahun);
        $data['title'] = 'E-SPK | Dashboard';
        $data['position'] = 'Halaman Utama';
        ...
        // Mendapatkan data karyawan dengan peringkat terbaik
        $data['nilaiKaryawan'] = $this->admin_model->getNilaiKaryawan($tahun);

        // Panggil fungsi model untuk mendapatkan data peringkat karyawan
        $data['data'] = $this->admin_model->getRankKaryawan($tahun);
    ...
    public function reset($id)
    {
        if ($this->session->userdata('akses') == 'Administrator') {
            $data['admin'] = $this->admin_model->admin_Active();
            $data['title'] = 'Penilaian Kinerja Karyawan - Reset Password';
