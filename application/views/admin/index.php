        ...
        <div class="container-fluid">
                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Active Period</h5>
                                    <h3 class="mt-3 mb-3"><?= $aktif['waktu'] ?></h3>
                                    <p class="mb-0 text-muted">
                                        <span class="text-success me-2"><i class="uil-info-circle"></i> validated data</span>
                                    </p>
                                </div> <!-- end card-body-->
                            </div> <!-- end card-->
                        </div> <!-- end col-->
                        ...
                        <div class="col-sm-6">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Assesment Total</h5>
                                    <h3 class="mt-3 mb-3"><?= $penilai['jumlah'] ?></h3>
                                    <p class="mb-0 text-muted">
                                        <span class="text-success me-2"><i class="uil-info-circle"></i> validated data</span>
                                    </p>
                                </div> <!-- end card-body-->
                        ...
                        <div class="col-sm-12">
                            <div class="card widget-flat">
                                <div class="card-body">
                                    ...
                                    <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Employment Total</h5>
                                    <h3 class="mt-3 mb-3"><?= $guru ?></h3>
                                    <p class="mb-0 text-muted">
                                        <span class="text-success me-2"><i class="uil-info-circle"></i> validated data</span>
                                    </p>
                                </div> <!-- end card-body-->
                ...
                <div class="col-xl-7 col-lg-6">
                    <div class="card card-h-100">
                        <div class="d-flex card-header justify-content-between align-items-center">
                            <h4 class="header-title">Rating percentage</h4>
                        </div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="card">
                        <div class="d-flex card-header justify-content-between align-items-center">
                            <h4 class="header-title">Employee Ranking</h4>
                        </div>
                        <div class="card-body pt-0">
                            <div dir="ltr">
